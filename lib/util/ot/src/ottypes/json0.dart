 ...
 * @type {*}
 */
class OT_json0 extends OTTypeFactory<dynamic, List<Map>> with _BootstrapTransform<Map> {
...
//  final Function _deepEq = (a, b) => true;
  ...
  @override
  dynamic apply(dynamic snapshot, List<Map> op) {
    checkValidOp(op);
  ...
  @override
  List<Map> compose(List<Map> op1, List<Map> op2) {
    checkValidOp(op1);
    checkValidOp(op2);
...
class _JsonOpComponent {
  ...
  _JsonOpComponent([this.opc = const {'p': []}]);
