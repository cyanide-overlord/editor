...
class _$ThemePreset extends ThemePreset {
  ...
  factory _$ThemePreset([void Function(ThemePresetBuilder)? updates]) =>
      (new ThemePresetBuilder()..update(updates))._build();

  _$ThemePreset._(
      {required this.projectBrowserBackground,
      required this.termBackground,
      required this.text,
      required this.textActive,
      required this.windowHeader,
      required this.windowHeaderActive,
      required this.fileTreeSelectedFile})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        projectBrowserBackground, r'ThemePreset', 'projectBrowserBackground');
    BuiltValueNullFieldError.checkNotNull(
        termBackground, r'ThemePreset', 'termBackground');
    BuiltValueNullFieldError.checkNotNull(text, r'ThemePreset', 'text');
    BuiltValueNullFieldError.checkNotNull(
        textActive, r'ThemePreset', 'textActive');
    BuiltValueNullFieldError.checkNotNull(
        windowHeader, r'ThemePreset', 'windowHeader');
    BuiltValueNullFieldError.checkNotNull(
        windowHeaderActive, r'ThemePreset', 'windowHeaderActive');
    BuiltValueNullFieldError.checkNotNull(
        fileTreeSelectedFile, r'ThemePreset', 'fileTreeSelectedFile');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ThemePreset')
...
class ThemePresetBuilder implements Builder<ThemePreset, ThemePresetBuilder> {
  ...
  @override
  ThemePreset build() => _build();

  _$ThemePreset _build() {
    final _$result = _$v ??
        new _$ThemePreset._(
