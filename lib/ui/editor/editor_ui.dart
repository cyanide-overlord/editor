...
import 'package:editor/ui/painting/util/text_layout_cache.dart';
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var line in lines.skip((-scroll.dy / lineHeight).floor()).take((size.height / lineHeight).ceil())) {
      ...
      if (cursorBlink && cursor.endLine == i - 1) {
        final o = painter.getOffsetForCaret(TextPosition(offset: cursor.endPosition, affinity: TextAffinity.upstream),
